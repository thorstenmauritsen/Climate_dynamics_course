...
The variance of an AR(1) process is determined by this memory parameter and the driving white noise process. For the mixed layer model, this white noise process is the noise in the radiative forcing, $\sigma_F$, and the variance in the temperature can be described by:

\begin{equation}
	\sigma^{2}_T = \frac{\sigma^{2}_F}{1 - \alpha^{2}}
\end{equation}
