...
\newcommand{\DocTitle}{Global Climate Course Notes}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15 cm]{../plots/Qubicon_histogram.png}
	\end{center}
...
%An interesting question is if there is a feedback between droughts and precipitation? 
