...
\begin{figure}
\begin{center}
\includegraphics[width=17 cm]{GW_Petty_IRIS_Tropical_Western_Pacific.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=8 cm]{atmospheric-radiation-13c-heating-rates-tropical-each-h2o-co2-o3.png}
\end{center}
